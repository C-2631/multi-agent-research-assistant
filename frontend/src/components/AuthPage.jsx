      ...
      >
        ...
        >
          ...
          <div style={{
            ...
            <span style={{ color: 'var(--color-text-muted)', fontSize: '0.75rem', textTransform: 'uppercase', letterSpacing: '0.1em' }}>
              or continue with
            </span>
            <div style={{ flex: 1, height: '1px', background: 'var(--border-color)' }} />
          </div>
          ...
          <div style={{ display: 'flex', gap: '0.75rem' }}>
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              onClick={() => alert('Google OAuth requires configuration. Add your Google Client ID to enable this feature.')}
              style={{
                flex: 1,
                display: 'flex',
                alignItems: 'center',
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => alert('Facebook OAuth requires configuration. Add your Facebook App ID to enable this feature.')}
              style={{
                flex: 1,
                display: 'flex',
                alignItems: 'center',
